...
UploadBuffer::Allocation UploadBuffer::allocate(size_t sizeInBytes,
    size_t alignment) {
...
UploadBuffer::Page::Page(size_t sizeInBytes) : size(sizeInBytes) {
    ...
    chkDX(device->CreateCommittedResource(&uploadHeapProperties,
...
UploadBuffer::Allocation UploadBuffer::Page::allocate(size_t sizeInBytes,
    size_t alignment) {
